...
module.exports = function(app){
  ...
  function uploadImage(req, res) {
    ...
    if (myFile == null || myFile == "") {
      // return "http://localhost:4200/user/website/" + websiteId + "/page/" + pageId + "/widget/" + widgetId;
      return "https://frank-web-project.herokuapp.com/user/website/" + websiteId + "/page/" + pageId + "/widget/" + widgetId;
    }
    ...
    if (widgetId === undefined || widgetId === null || widgetId === '') {
      ...
      widgetModel.createWidget(pageId, widget)
        .then(function (widget) {
            ...
            //   res.send(widget);
            // }
            // res.redirect("http://localhost:4200/user/website/" + websiteId + "/page/" + pageId + "/widget/");
            res.redirect("https://frank-web-project.herokuapp.com/user/website/" + websiteId + "/page/" + pageId + "/widget/");
          }, function(error) {
